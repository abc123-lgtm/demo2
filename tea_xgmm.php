                                    ...
                                    <div class="position-center">
                                        <form role="form" action="tea_xgmm.php?action=update" method="post">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputEmail1" name="tea_id" value="<?php echo $_SESSION['teacher_id'] ?>" readonly="readonly">
                                            </div>
                                            <div class="form-group" >
    ...
    if ($arr['password'] != $psw) {
        ...
        if ($psw1 != $psw2) {
            ...
            if ($res) {
                ...
                echo "<script type='text/javascript'>" . "location.href='" . "index_tea.php" . "'" . "</script>";
            } else {
