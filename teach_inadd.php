                        ...
                        <div>
                            <table class="table" ui-jq="footable" ui-options='{
                                    ...
                                    <tbody>
                                        ...
                                        $sql = "select * from course where teach_id='$A' and course_id in(select course_id from grade where  flag='0')";
                                        ...
                                        while ($arr = mysql_fetch_assoc($res)) {
                                            ...
                                            echo "<td>" . $arr['blps'] . "</td>";
                                            echo "<td>" . $arr['blks'] . "</td>";
                                            $sql1="select flag from grade where course_id='$lorbu'";
                                            $result=mysql_fetch_array(mysql_query($sql1,$conn));
                                             $count=$result['flag']; 
                                            if($count=='0'){
