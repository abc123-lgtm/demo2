                        ...
                        <div class="panel-body">
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1" name="course_id" required="required">
                                </div>
                                    <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputPassword1"  name="credit">
                                </div>
                                    <div class="form-group">
                                    <label for="exampleInputText1">开课时间</label>
                                    <input type="text" class="form-control" id="exampleInputPassword1"  name="xktime">
                                </div>
                                    <div class="form-group">
                                    <label for="exampleInputText1">平时比例</label>
                                    <input type="text" class="form-control" id="exampleInputPassword1"  name="blps">
                                </div>
                                    <div class="form-group">
                                    <label for="exampleInputText1">考试比例</label>
                                    <input type="text" class="form-control" id="exampleInputPassword1"  name="blks">
                                </div>
                                     <div class="form-group" >
