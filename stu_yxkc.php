    ...
    <div>
      ...
      <table class="table" ui-jq="footable" ui-options='{
        ...
        <?php
             ...
             $sql="select course.*,teacher.* from course,teacher  where  course.teach_id=teacher.teach_id and course.xktime='$val' and  course.course_id =any(select course_id from grade where stuno='$A' and flag='0')";
             }
             mysql_query("set names 'utf8'");
             ...
             //echo  "<td><a href='stu_startxk.php?flag=".$arr['course_id']."'>选课</a></td>";
             echo  "</tr>"; 
             }   }
             else{
